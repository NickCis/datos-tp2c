...
#define USUARIOS_HASH_BLOQUE_PATH "./user_hash_block.dat"
...
#define SERVICIOS_HASH_BAJA_PATH "./serv_hash_baja.dat"
#define SERVICIOS_HASH_BLOQUE_SIZE (512)
#define SERVICIOS_LAST_ID_FILE "./serv_last_id.dat"
#define SERVICIOS_INDICE_CAT_PATH "./serv_arbm_cat.dat"
#define SERVICIOS_ARBM_CAT_ORDEN (64)
